...
: ${TURTLEBOT_STAGE_MAP_FILE:=`rospack find turtlebot_stage`/maps/robopark_plan.yaml}
: ${TURTLEBOT_STAGE_WORLD_FILE:=`rospack find turtlebot_stage`/maps/stage/robopark_plan.world}
# Exports
